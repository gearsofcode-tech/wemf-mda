...
public class HasNoAnnotationTagProcessor extends AbstractStandardConditionalVisibilityTagProcessor{

	private static final String attrName = "hasNoAnnotation";
	private static final int PRECEDENCE = 10000;
	
	protected HasNoAnnotationTagProcessor(final String dialectPrefix) {
